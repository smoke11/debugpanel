package smoke11;
/**
 * Creator of the class: Software Monkey
 * Source: http://stackoverflow.com/questions/342990/create-java-console-inside-the-panel/343007#343007
 */

import java.io.*;
import java.io.CharArrayWriter;import java.io.OutputStream;import java.io.PrintWriter;import java.lang.*;import java.lang.Integer;import java.lang.String;import java.lang.System;import java.lang.Thread;import java.lang.Throwable;import java.util.*;import java.util.LinkedList;
...
// *****************************************************************************
    ...
    public TextAreaOutputStream(JTextArea ta, int ml) {
        //if(ml<1) { throw new IoEscape(IoEscape.GENERAL,"Maximum lines of "+ml+" in smoke11.TextAreaOutputStream constructor is not permitted"); }
        textArea=ta;
        maxLines=ml;
...
// *****************************************************************************
    ...
    public synchronized void write(byte[] ba,int str,int len) {
        try {
            ...
            textArea.append(java.lang.System.getProperty("line.separator","\n"));
